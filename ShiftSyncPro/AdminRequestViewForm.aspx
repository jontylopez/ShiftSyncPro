<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminRequestViewForm.aspx.cs" Inherits="ShiftSyncPro.WebForm13" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <asp:Button ID="btnViewProofDocument" runat="server" Text="View Proof Document" CssClass="common-button" OnClick="btnViewProofDocument_Click" />
        ...
        <div class="common-form-group">
            <asp:Label ID="lblSupervisorComment" runat="server" Text="HR Comment:" CssClass="common-input-label"></asp:Label>
